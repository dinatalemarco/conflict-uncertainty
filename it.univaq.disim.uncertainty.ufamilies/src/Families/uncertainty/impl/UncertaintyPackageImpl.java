...
public class UncertaintyPackageImpl extends EPackageImpl implements UncertaintyPackage {
	...
	public static UncertaintyPackage init() {
		...
		UncertaintyPackageImpl theUncertaintyPackage = (UncertaintyPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof UncertaintyPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new UncertaintyPackageImpl());
